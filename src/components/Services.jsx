    ...
    <div class="container">
       ...
       {/* <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                          ...
                          <h2 class="text-bold">The Team Behind Pacifico</h2>
        ...
        <div className="m-2">
    <div class="text-cyan-600  m-3">

<h2 class="gap-2 mt-4">THE SOURCE OF THE DISPLAYED DATA IS EITHER THE PROPERTY OWNER OR PUBLIC RECORD PROVIDED BY NON-GOVERNMENTAL THIRD PARTIES. IT IS BELIEVED TO BE RELIABLE BUT NOT GUARANTEED. THIS INFORMATION IS PROVIDED EXCLUSIVELY FOR CONSUMERS’ PERSONAL, NON-COMMERCIAL USE.</h2>

<h2 className="gap-2 mt-4">575 MADISON AVENUE, NEW YORK, NY 10022. 212. 891.7000 ©️ 2021  Caseymiltonhomes REAL ESTATE. ALL MATERIAL PRESENTED HEREIN IS INTENDED FOR INFORMATION PURPOSES ONLY. WHILE, THIS INFORMATION IS BELIEVED TO BE CORRECT, IT IS REPRESENTED SUBJECT TO ERRORS, OMISSIONS, CHANGES OR WITHDRAWAL WITHOUT NOTICE. ALL PROPERTY INFORMATION, INCLUDING, BUT NOT LIMITED TO SQUARE FOOTAGE, ROOM COUNT, NUMBER OF BEDROOMS AND THE SCHOOL DISTRICT IN PROPERTY LISTINGS SHOULD BE VERIFIED BY YOUR OWN ATTORNEY, ARCHITECT OR ZONING EXPERT. EQUAL HOUSING OPPORTUNITY.  Fair Housing Logo  CalBRE# 01947727. </h2>

<h2  className="gap-2 mt-4"> Caseymiltonhomes COMMITMENT TO FAIR HOUSING LAWS, STANDARD OPERATING PROCEDURES, AND REASONABLE ACCOMMODATIONS.
</h2>
<h3 className="gap-2 mt-4">POWERED BY GTS: REAL ESTATE WEBSITES | REAL ESTATE CRM</h3>
